...
!(function (t, n) {
		...
		function h(e) {
			...
			function I(t) {
				...
				switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
					...
					case yo:
						(x &&
							((a = _o(S, bo(k, i - C * x))), (h = _o(S, bo(k, l + C * x)))),
							w &&
		...
		function f() {
			...
			if (
				...
				if (t) {
					...
					(c.quadraticCurveTo(0, 0, v * Uo(_), v * Io(_)),
						c.arc(0, 0, v, _, b));
	...
	function Vy(t, n) {
		return (
			(t = Gy(t)),
			Xg(wg.count(qg(t), t) + (4 === qg(t).getUTCDay()), n, 2)
		);
	}
	function $y(t) {
		return t.getUTCDay();
